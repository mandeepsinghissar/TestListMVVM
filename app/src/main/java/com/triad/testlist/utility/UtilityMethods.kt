...
//            crypted = cipher.doFinal(input.getBytes());
    ...
    fun tokenValue(): String {
        ...
        tokenVal =
            year + Constants.KeyToken + PreferenceConfiguration.getPreference(
                Constants.PreferenceConstants.TOKEN
            )
        return tokenVal
    }
